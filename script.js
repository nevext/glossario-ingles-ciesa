...
const lawGlossario = {
  ...
  "due process": "Princípio do Devido Processo Legal — garantia de procedimento justo com contraditorio e ampla defesa (CF art. 5o, LIV).",
  ...
  "principle of legality": "Administração so pode fazer o que a lei expressamente autoriza (vinculação positiva à lei).",
  ...
  "civil law": "Direito Civil — normas que regulam relaçoes privadas entre pessoas físicas e jurídicas.",
  ...
  "legal capacity": "Aptidão para ser titular de direitos e obrigaçoes (capacidade de direito) e exercê-los (capacidade de fato).",
  ...
  "criminal law": "Direito Penal — define crimes, contravençoes e aplica penas ou medidas de segurança.",
  ...
  "labor law": "Direito do Trabalho — regulação das relaçoes de emprego e proteção do trabalhador. CLT.",
  ...
  "international law": "Direito Internacional Público — normas que regem relaçoes entre Estados e organizaçoes.",
  ...
  "patent law": "Patentes — proteção de invençoes por prazo determinado. INPI no Brasil.",
  "trademark law": "Marcas — sinais distintivos registrados no INPI.",

  "environmental law": "Direito Ambiental — proteção do meio ambiente.",
  "consumer protection law": "Codigo de Defesa do Consumidor — Lei 8.078/90.",

  "jurisprudence": "Conjunto de decisoes reiteradas dos tribunais que orientam a interpretação do direito.",
  ...
  "immigration law": "Direito Migratorio — entrada e permanência de estrangeiros.",
