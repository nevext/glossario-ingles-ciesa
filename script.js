...
const techGlossario = {
  ...
  "ciesa": "Centro de Integração Empresa-Escola — instituição que conecta estudantes a oportunidades de estágio e emprego.",
  ...
  "laburatory 4": "Laboratório 4 fica no quarto andar do prédio do ciesa, equipado com recursos avançados para atividades práticas de tecnologia e direito, incentivando a inovação, a pesquisa e o desenvolvimento de projetos interdisciplinares.",
  "laburatory 5": "Laboratório 5 fica no quinto andar do prédio do ciesa, equipado com recursos de ponta para atividades práticas de tecnologia e direito, promovendo a excelência acadêmica, a pesquisa avançada e o desenvolvimento de projetos inovadores.(tecnologia e loucuras no computqdor)",
...
const lawGlossario = {
  ...
  "princípio da impessoalidade": "Atos administrativos devem buscar o interesse público, sem privilégios pessoais.",
  ...
  "crime": "Fato típico, ilícito e culpável. Tipicidade: conduta prevista em lei. Ilicitude: sem excludentes.",
  ...
  "burden of proof": "Ônus da prova — quem alega deve provar. Autor: fatos constitutivos | Réu: extintivos.",
  ...
  "trademark law": "Marcas — sinais distintivos registrados no INPI. Proteção por 10 anos, renovável.",
